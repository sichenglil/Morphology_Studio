...
def main() -> int:
    ...
    try:
        ...
        success, result = omni.kit.commands.execute("URDFParseAndImportFile", urdf_path=str(args.input.resolve()), import_config=config, dest_path=str(args.output.resolve()))
        if not success:
