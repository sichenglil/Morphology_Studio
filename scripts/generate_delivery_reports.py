...
SKIP = {".git", "node_modules", "build", "dist", "release", "_archive", "__pycache__"}
...
Command: python -m PyInstaller packaging\\MorphologyStudio.spec --noconfirm --clean
...
Generated GIFs: 1 (512x512, 60 frames, 20 FPS)
...
Resource verifier: PASS (40 links, 39 joints, 56 mesh references, 0 missing, 60 GIF frames)
