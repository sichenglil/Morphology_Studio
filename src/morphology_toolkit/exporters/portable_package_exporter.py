...
class PortablePackageExporter:
    def export(self, model: RobotModel, output: Path, resolver: ResourceResolver) -> Path:
        ...
        for resource in portable.resources:
            ...
            folder = "meshes" if suffix in {".stl", ".obj", ".dae", ".ply", ".glb", ".gltf"} else "textures" if suffix in {".png", ".jpg", ".jpeg", ".tga", ".bmp"} else "resources"
        ...
        portable.extension_elements = [replace_many(raw, uri_map) for raw in portable.extension_elements]
