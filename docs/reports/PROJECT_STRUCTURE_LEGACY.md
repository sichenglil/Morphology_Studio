...
- `project/desktop_entry.py`: Windows desktop entry point.
...
- `scripts/build/packaging/MorphologyStudio.spec`: PyInstaller onedir definition.
- `tests`: Python unit/integration/documentation tests.
- `artifacts/archive`: retained legacy or uncertain files, excluded from release.
