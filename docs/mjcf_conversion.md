...
python scripts/validation/validate_mjcf.py --input artifacts/temporary/ur5e.xml --json artifacts/reports/ur5e_mjcf_conversion.json --markdown artifacts/reports/ur5e_mjcf_conversion.md
```
