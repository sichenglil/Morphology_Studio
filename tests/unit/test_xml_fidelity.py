...
def test_unknown_extensions_round_trip_and_rewrite(tmp_path: Path):
    ...
    source.write_text(
        """<robot name="extended"><link name="base"/><gazebo reference="base"><plugin name="p" filename="plugin"><frame>base</frame></plugin></gazebo><ros2_control name="system" type="system"><joint name="drive"/></ros2_control><transmission name="t"><joint name="drive"/></transmission></robot>""",
        encoding="utf-8",
    )
