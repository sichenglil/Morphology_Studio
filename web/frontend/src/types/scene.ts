...
export interface SceneManifest { robotId: string | null; displayName?: string; rootLinks: string[]; links: LinkNode[]; joints: JointNode[]; resources: string[]; sourceFormat?: string; revision:number; rootTransform:Transform; assemblyJoints:string[]; history:HistoryState }
